...
BEGIN
	...
	FROM polls
	JOIN users
	ON users.id = polls.owner_id
	WHERE polls.owner_id = owner_id_input;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	ELSE
		SELECT u.id, u.email, u.username, u.first_name, u.last_name, u.profile_image, u.created_at, u.dob, us.token
		FROM users u
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`innotech`@`%` PROCEDURE `patch_all`(id_input INT(10)UNSIGNED, email_input VARCHAR(100), last_name_input VARCHAR(100), profile_image_input VARCHAR(500))
    MODIFIES SQL DATA
BEGIN
	UPDATE users
	SET last_name = last_name_input, email = email_input, profile_image = profile_image_input
	WHERE id = id_input;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `patch_email_image` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`innotech`@`%` PROCEDURE `patch_email_image`(id_input INT(10)UNSIGNED, email_input VARCHAR(100), profile_image_input VARCHAR(500))
    MODIFIES SQL DATA
BEGIN
		UPDATE users u
		SET email = email_input, profile_image = profile_image_input
		WHERE u.id = id_input;
	END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `patch_image` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`innotech`@`%` PROCEDURE `patch_image`(id_input INT(10)UNSIGNED, profile_image_input VARCHAR(500))
    MODIFIES SQL DATA
BEGIN
		UPDATE users u
		SET profile_image = profile_image_input
		WHERE u.id = id_input;
	END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `patch_ln_email` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`innotech`@`%` PROCEDURE `patch_ln_email`(id_input INT(10)UNSIGNED, last_name_input VARCHAR(100), email_input VARCHAR(100))
    MODIFIES SQL DATA
BEGIN
		UPDATE users u
		SET last_name = last_name_input, email = email_input
		WHERE u.id = id_input;
	END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `patch_ln_image` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`innotech`@`%` PROCEDURE `patch_ln_image`(id_input INT(10)UNSIGNED, last_name_input VARCHAR(100), profile_image_input VARCHAR(500))
    MODIFIES SQL DATA
BEGIN
		UPDATE users u
		SET last_name = last_name_input, profile_image = profile_image_input
		WHERE u.id = id_input;
	END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`innotech`@`%` PROCEDURE `patch_user`(id_input INT(10)UNSIGNED, last_name_input VARCHAR(100))
    MODIFIES SQL DATA
BEGIN
		UPDATE users u
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`innotech`@`%` PROCEDURE `user_signup`(username_input VARCHAR(100), password_input VARCHAR(100), email_input VARCHAR(100), dob_input DATE, token_input VARCHAR(45), profile_image_input VARCHAR(500), first_name_input VARCHAR(100), last_name_input VARCHAR(100))
    MODIFIES SQL DATA
BEGIN
	IF profile_image_input IS NULL THEN
	...
	ELSE
		INSERT INTO users(username, password, email, dob, profile_image, first_name, last_name)
		VALUES(username_input, password_input, email_input, dob_input, profile_image_input, first_name_input, last_name_input);
	SET @new_user_id = LAST_INSERT_ID();
	INSERT INTO user_session (token, user_id)
		VALUES (token_input, @new_user_id);
	SELECT user_id, token
...
-- Dump completed on 2023-03-11 15:29:18
